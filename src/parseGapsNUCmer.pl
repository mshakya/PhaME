...
( my $q_file_name, undef, undef ) =
  fileparse( "$query_full_path", qr/\.[^.]*/ );
$r_file_name =~ s/\.fna//;
$q_file_name =~ s/\.fna//;
$r_file_name =~ s/\.fasta//;
$q_file_name =~ s/\.fasta//;
...
open( OUT,  "> nucmer/${r_file_name}_${q_file_name}.gaps" );
open( OUT2, "> nucmer/${q_file_name}_${r_file_name}.gaps" );
...
#                  print $ref,"\t",$gap_array[0],"\t",$gap_array[-1],"\t",$gap_len,"\t",$q_file_name,"\n";
                        print OUT $r_file_name, "\t", $gap_array[0], "\t",
                          $gap_array[-1], "\t", $gap_len, "\t", $q_file_name,
                          "\n";
                    }
                    @gap_array = ();
                }
...
#         print $ref,"\t",$gap_array[0],"\t",$gap_array[-1],"\t",$gap_len,"\t",$q_file_name,"\n";
            print OUT $r_file_name, "\t", $gap_array[0], "\t", $gap_array[-1],
              "\t", $gap_len, "\t", $q_file_name, "\n";
        }
    }
...
#                  print $ref,"\t",$gap_array[0],"\t",$gap_array[-1],"\t",$gap_len,"\t",$r_file_name,"\n";
                        print OUT2 $q_file_name, "\t", $gap_array[0], "\t",
                          $gap_array[-1], "\t", $gap_len, "\t", $r_file_name,
                          "\n";
                    }
                    @gap_array = ();
                }
...
#         print $ref,"\t",$gap_array[0],"\t",$gap_array[-1],"\t",$gap_len,"\t",$r_file_name,"\n";
            print OUT2 $q_file_name, "\t", $gap_array[0], "\t", $gap_array[-1],
              "\t", $gap_len, "\t", $r_file_name, "\n";
        }
    }
